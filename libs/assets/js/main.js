...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		var sc_href = $('#skin_color').attr("href");
			sc_href = sc_href.replace('theme-1', appSetting.theme);
		$('#skin_color').attr("href", sc_href);
		...
		$('input[name="setting-theme"]').change(function() {
			...
			var sc_href = $('#skin_color').attr("href");
			sc_href = sc_href.replace('theme-1', selectedTheme);
			$('#skin_color').attr("href", sc_href);
		...
		function defaultSetting() {
			...
			var sc_href_def = $('#skin_color').attr("href");
			$('#skin_color').attr("href", sc_href_def);
			$(".navbar-brand img").attr("src", "assets/images/logo.png");
